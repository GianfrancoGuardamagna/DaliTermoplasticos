    ...
    return (
        <div className='h-full flex flex-col justify-start items-center sm:bg-none bg-no-repeat bg-contain bg-right-bottom gap-6 pt-4'>
            ...
            <div className='flex flex-col mx-auto w-full sm:w-[90%] gap-4 md:w-[95%] h-[calc(100vh-112px)] md:h-[calc(70vh-112px)] lg:h-[calc(100vh-112px)] md:flex-row-reverse md:items-center md:justify-center md:gap-6'>
                ...
                <p className='text-center font-museo text-sm w-[90%] mx-auto sm:text-base md:w-1/2 md:text-start xl:text-xl 2xl:text-2xl'>
                ...
                Además, en nuestra planta contamos con sistemas de recirculación de agua a lo largo de todo el proceso productivo, e Implementamos un sistema de tratamiento de efluentes que nos permite evitar la contaminación y garantizar la sostenibilidad de nuestras operaciones.Esto nos permite optimizar el uso de este recurso vital y reducir significativamente el consumo de agua, manteniendo altos estándares de eficiencia y minimizando el impacto ambiental. 
                </p>
            </div>
                <div className='flex flex-col gap-4 items-center justify-center lg:w-full lg:gap-8'>
                    ...
                    <div className='flex flex-col justify-center w-full xl:gap-12'>
